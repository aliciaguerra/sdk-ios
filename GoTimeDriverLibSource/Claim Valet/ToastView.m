...
+ (void)showToastInParentView: (UIView *)parentView withText:(NSString *)text withDuaration:(float)duration;
{
    ...
    float x = (parentRect.size.width - ToastWidth) / 2;
    float y = (parentRect.size.height - ToastHeight) / 2;
    CGRect selfFrame = CGRectMake(x, y, ToastWidth, ToastHeight);
